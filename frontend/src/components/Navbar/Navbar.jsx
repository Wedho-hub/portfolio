			...
			<Container>
				{/* Brand/Logo */}
				   <Navbar.Brand as={Link} to="/" className="fw-bold logo d-flex align-items-center" onClick={handleNavClick}>
					   {/* Inline SVG logo so it inherits color via currentColor */}
					   <svg className="logo-svg" width="64" height="64" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style={{ marginRight: 12 }}>
						   <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
							...
							-17 0 -31 -5 -31 -4 0 5 75 134 166 285 155 257 168 276 194 276 16 0 31 -3
							33 -7z m3874 -52 c103 -47 191 -85 197 -85 5 0 9 -15 9 -33 0 -32 -1 -33 -142
							-96 -79 -35 -165 -75 -192 -88 -64 -30 -68 -29 -64 9 3 32 6 34 161 99 86 36
							159 68 161 70 3 2 -69 36 -160 74 l-164 70 0 32 c0 18 2 33 4 33 2 0 87 -38
							190 -85z m-2884 -10 l0 -85 85 0 85 0 0 -30 0 -30 -85 0 -85 0 0 -85 0 -85 -30 0 -30 0 0 85 0 85 -85 0 -85 0 0 30 0 30 85 0 85 0 0 85 0 85 30 0 30 0 0 -85z m1810 -50 l0 -25 -200 0 -200 0 0 25 0 25 200 0 200 0 0 -25z m460 0 l0 -25 -200 0 -200 0 0 25 0 25 200 0 200 0 0 -25z m-2630 -84 c77 -55 61 -181 -27 -217 -69 -30 -141 7 -162 81 -32 116 92 205 189 136z m2170 -41 l0 -30 -200 0 -200 0 0 30 0 30 200 0 200 0 0 -30z m460 0 l0 -30 -200 0 -200 0 0 30 0 30 200 0 200 0 0 -30z m-1185 -106 c19 -20 16 -63 -6 -77 -9 -5 -28 -7 -42 -3 -22 5 -27 12 -27 39 0 54 40 75 75 41z"/>
